...
parser.add_argument('--config', dest='config', help='settings of detection in yaml format',\
    default='./configs/insmonodetr.yaml')
...
def main():
    ...
    set_random_seed(cfg.get('random_seed', a))
    ...
    logger.info('Batch Size: %d' % (cfg['dataset']['train_batch_size']))
    ...
    logger.info('###################  Testing  ##################')
    logger.info('Batch Size: %d' % (cfg['dataset']['test_batch_size']))
