...
class DepthPredictor(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        self.depth_bin_values = nn.Parameter(bin_value, requires_grad=False) # shape 81
    ...
    def forward(self, feature, mask, pos):
        ...
        weighted_depth = (depth_probs * self.depth_bin_values.reshape(1, -1, 1, 1)).sum(dim=1) # (B,1,24,80) #sum of depth_probs * self.depth_bin_values to be the depth value
        #ipdb.set_trace()
