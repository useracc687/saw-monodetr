...
from ...monodetr.position_encoding import build_position_encoding
...
def build_backbone(cfg):
    ...
    backbone = PResNet(variant=cfg['variant'],depth=cfg['depth'],freeze_at=cfg['freeze_at'],
                    return_idx=cfg['return_idx'],freeze_norm=cfg['freeze_norm'],pretrained=cfg['pretrained'])
